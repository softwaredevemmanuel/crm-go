...
type EnrollmentProgress struct {
	...
	CurrentModuleID *uuid.UUID `gorm:"type:uuid;index"`                                                                     // Current module student is on
	CurrentTopicID  *uuid.UUID `gorm:"type:uuid;index"`                                                                     // Current topic student is on
	...
	// Completion Metrics
	CompletedModules     int `gorm:"default:0"` // Number of modules completed
	TotalModules         int `gorm:"default:0"` // Total modules in course
	CompletedTopics      int `gorm:"default:0"` // Number of topics completed
	TotalTopics          int `gorm:"default:0"` // Total topics in course
