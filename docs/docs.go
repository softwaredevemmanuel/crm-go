    ...
    "paths": {
        ...
        "/api/terms/bulk": {
            "post": {
                ...
                "description": "Create multiple terms for an academic session",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Bulk create terms",
                "parameters": [
                    {
                        "description": "Bulk term request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.BulkCreateTermsRequest"
                        }
                    }
                ],
                "responses": {
