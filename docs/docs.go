...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/academic-sessions": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search by year, code, or description",
                        "name": "search",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Academic session creation request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/academic-sessions/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Academic session update request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/subjects/department/head-of-department/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "dto.SubjectResponse": {
            ...
            "properties": {
                ...
                "department": {
                    "$ref": "#/definitions/dto.DepartmentBriefResponse"
                },
                "department_id": {
                    "type": "string"
                },
